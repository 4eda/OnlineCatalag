<template>
    <div>
        ...
        <div class="form-group">
            <router-link :to="{name: 'createCompany'}" class="btn btn-success">Добавить новую книгу</router-link>
        </div>
    </div>
</template>
    ...
    export default {
        ...
        mounted() {
            ...
            axios.get('/api/v1/companies')
                ...
                .catch(function (resp) {
                    console.log(resp);
                    alert("Не удалось обновить информацию о кнгигах");
                });
        },
        methods: {
            deleteEntry(id, index) {
                if (confirm("Вы действительно хотите удлаить?")) {
                    var app = this;
